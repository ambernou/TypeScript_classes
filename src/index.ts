...
// Задание 2:
// Поскольку эти данные пока ниоткуда не передаются, то просто захардкодила 
const userName = 'Wade Warren'
const avatarSrc = 'img/avatar.png'
const favoriteItemsAmount = 0

// Задание 3:
// Не удалось подключить luxon для работы датами, поэтому пока реализовала через new Date()
